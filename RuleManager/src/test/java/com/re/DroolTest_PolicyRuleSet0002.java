...
@SpringBootTest*/
public class DroolTest_PolicyRuleSet0002 {
    ...
    public void testPolicyRuleSet0001_1(){
        ...
        String agendaGroup = "policyRuleSet_2_v1.00";
        String drlPath = "src/test/resources/rule/policyRuleSet_002.drl";
        ...
        assert droolsRuleLog.get().getHitCount() == 4;
